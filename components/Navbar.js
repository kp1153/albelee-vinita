          ...
          {showSearch && (
            <div className="pb-3">
              <form onSubmit={handleSearch} className="relative">
                ...
                <button
                  type="submit"
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-[#D85A8C]"
                >
                  <FaSearch />
                </button>
              </form>
      ...
      {mobileOpen && (
        <div className="fixed top-0 left-0 right-0 bottom-0 z-[200] bg-[#FFF3F6] overflow-y-auto md:hidden">
          <div className="flex items-center justify-between px-4 py-4 border-b border-[#F6C9D6]">
            <span className="font-serif text-xl font-bold text-stone-900 tracking-widest">
              ALBELEE
            </span>
            <button
                ...
                {!item.children ? (
                  ...
                  <>
                    ...
                    >
                      {item.name}
                      <FaChevronDown
                        className={`transition-transform text-sm ${mobileDropdown === index ? "rotate-180" : ""}`}
                      />
                    </button>
