    ...
    <div className="min-h-screen bg-[#FFF7F8] py-8">
      ...
      {showConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-md w-full border border-[#F6C9D6]">
            <h2 className="text-xl font-bold text-stone-800 mb-4">Order Confirm करें</h2>
            ...
            <div className="border-t border-[#F6C9D6] pt-3 mb-5">
              ...
              <p className="text-sm text-gray-700">{formData.address}, {formData.city}, {formData.state} - {formData.pincode}</p>
            </div>
